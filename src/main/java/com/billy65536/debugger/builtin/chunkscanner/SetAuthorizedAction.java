...
public class SetAuthorizedAction implements IDebugAction {
    ...
    public static final Identifier ID = BdtMod.id("cs.configuration-locker.set-authorized");
    ...
    @Override
    public Text getName() {
        return Text.translatable("bdt.action.cs.configuration-locker.set-authorized.name");
    }

    @Override
    public Text getDescription() {
        return Text.translatable("bdt.action.cs.configuration-locker.set-authorized.desc");
    }

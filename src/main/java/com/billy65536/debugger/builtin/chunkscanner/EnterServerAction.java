...
public class EnterServerAction implements IDebugAction {
    ...
    public static final Identifier ID = BdtMod.id("cs.configuration-locker.enter-server");
    ...
    @Override
    public Text getName() {
        return Text.translatable("bdt.action.cs.configuration-locker.enter-server.name");
    }

    @Override
    public Text getDescription() {
        return Text.translatable("bdt.action.cs.configuration-locker.enter-server.desc");
    }

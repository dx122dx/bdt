...
public class LeaveServerAction implements IDebugAction {
    ...
    public static final Identifier ID = BdtMod.id("cs.configuration-locker.leave-server");
    ...
    @Override
    public Text getName() {
        return Text.translatable("bdt.action.cs.configuration-locker.leave-server.name");
    }

    @Override
    public Text getDescription() {
        return Text.translatable("bdt.action.cs.configuration-locker.leave-server.desc");
    }

package com.billy65536.debugger.core.feature;
...
public final class FeatureRegistry {
    ...
    public static void register(IDebugFeature feature) {
        if (feature == null || feature.getId() == null) {
            BdtMod.LOGGER.warn("Attempted to register null feature or feature with null ID, ignored");
            return;
        }
        Identifier id = feature.getId();
        if (features.containsKey(id)) {
            BdtMod.LOGGER.warn("Debug feature {} is already registered, overwriting", id);
        }
        ...
        BdtMod.LOGGER.info("Registered debug feature: {} (enabled: {})", id, active);
    }
    ...
    public static boolean setEnabled(Identifier id, boolean value) {
        ...
        if (feature == null) {
            BdtMod.LOGGER.warn("Attempted to set state of unregistered feature: {}", id);
            return false;
        }
    ...
    private static void invokeCallback(IDebugFeature feature, boolean value) {
        try {
            ...
            BdtMod.LOGGER.error("Debug feature {} threw an exception in {} callback",

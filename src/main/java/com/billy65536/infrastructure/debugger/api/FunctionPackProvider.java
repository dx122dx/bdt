 ...
 * <pre>{@code
 * "entrypoints": {
 *   "infrastructure:debugger": ["com.example.mymod.MyDebugPackageContributor"]
 * }
 * }</pre>
 */
@FunctionalInterface

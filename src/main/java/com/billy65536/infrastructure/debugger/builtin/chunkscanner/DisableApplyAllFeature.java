...
public class DisableApplyAllFeature implements IDebugFeature {
    ...
    public static final Identifier ID = InfrastructureMod.id("cs.configuration-locker.disable-apply-all");
    ...
    @Override
    public Text getName() {
        return Text.translatable("billy-inf.feature.cs.configuration-locker.disable-apply-all.name");
    }

    @Override
    public Text getDescription() {
        return Text.translatable("billy-inf.feature.cs.configuration-locker.disable-apply-all.desc");
    }
}

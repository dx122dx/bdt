...
public class UnlockAllFeature implements IDebugFeature {
    ...
    public static final Identifier ID = InfrastructureMod.id("cs.configuration-locker.unlock");
    ...
    @Override
    public Text getName() {
        return Text.translatable("billy-inf.feature.cs.configuration-locker.unlock.name");
    }

    @Override
    public Text getDescription() {
        return Text.translatable("billy-inf.feature.cs.configuration-locker.unlock.desc");
    }
}

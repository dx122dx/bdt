package com.billy65536.chunkscanner.debugger.core.feature;
...
public final class FeatureRegistry {
    ...
    public static void register(IDebugFeature feature) {
        if (feature == null || feature.getId() == null) {
            CsDebuggerMod.LOGGER.warn("Attempted to register null feature or feature with null ID, ignored");
            return;
        }
        Identifier id = feature.getId();
        if (features.containsKey(id)) {
            CsDebuggerMod.LOGGER.warn("Debug feature {} is already registered, overwriting", id);
        }
        ...
        CsDebuggerMod.LOGGER.info("Registered debug feature: {} (enabled: {})", id, active);
    }
    ...
    public static boolean setEnabled(Identifier id, boolean value) {
        ...
        if (feature == null) {
            CsDebuggerMod.LOGGER.warn("Attempted to set state of unregistered feature: {}", id);
            return false;
        }
    ...
    private static void invokeCallback(IDebugFeature feature, boolean value) {
        try {
            ...
            CsDebuggerMod.LOGGER.error("Debug feature {} threw an exception in {} callback",
